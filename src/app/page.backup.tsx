...
export default function Home() {
  ...
  return (
    <>
      <div className="min-h-screen bg-gradient-to-br from-[#0C0A24] via-[#1A0F40] to-[#0C0A24] text-[#EAF1FF] overflow-hidden relative" style={{ fontFamily: 'Space Grotesk, system-ui, sans-serif' }}>

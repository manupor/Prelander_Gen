...
<!-- CTA Button -->
${ctaUrl !== '#' ? `<a href="${ctaUrl}" target="_blank" class="brand-cta">${cta}</a>` : ''}

<!-- Win Modal -->
<div id="winModal" class="win-modal-overlay" style="display: none;">
...
// Fallback: Show modal after 30 seconds if no interaction
setTimeout(function() {
  if (!hasShownModal) {
    document.getElementById('winModal').style.display = 'flex';
    hasShownModal = true;

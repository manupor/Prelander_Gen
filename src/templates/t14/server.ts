...
<body>
  ...
  <iframe 
    id="gameFrame"
    src="/templates/game/game.html?theme=underwater&url=${encodeURIComponent(ctaUrl || '#')}&popupTitle=${encodeURIComponent(popupTitle)}&popupMessage=${encodeURIComponent(popupMessage)}&popupPrize=${encodeURIComponent(popupPrize)}"
    allowfullscreen
  ></iframe>

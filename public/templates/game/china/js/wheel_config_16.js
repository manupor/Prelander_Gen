...
var wheelConfig = {
    ...
    createWheel: function(scene) {
        ...
        scene.wheel = addSprite("wheel", 0 - scene.wCont.x, 55 - scene.wCont.y, depth)?.setOrigin(0.5, 0.5).setAngle(11.25);
        ...
        for(var i = 0; i < scene.sectorsCount; i++)
        {
            ...
            scene.sectorsText[i] = scene.add.bitmapText(posX,  posY, 'gameFont_1', wheelConfig.sectors[i].text, 32, 1).setOrigin(0, 0.5);

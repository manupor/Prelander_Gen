...
var wheelConfig = {
    assetPath : 'pirates/',             // relative path to asset folder
    ...
    sectorsTextTint : 0x2c2c2c,         // sector text color
    winSectorsTextTint : 0xffffff,      // win sector text color
    animPointerDir : -1,                // ponter animation direction (-1 inverse)

...
var wheelConfig = {
    ...
    sprites: [
		{
            fileName: 'underwater_background.jpg',   // underwater background image (renamed without space)
            name: 'background',
        },
        {
    ...
    createWheel: function(scene) {
        ...
        if (scene.textures.exists('background')) {
            ...
            console.log('Underwater background created! Size: 2400x1400, Depth: -100');
            console.log('Background position:', scene.centerX, scene.centerY);
        } else {

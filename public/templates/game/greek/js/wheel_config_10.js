...
var wheelConfig = {
    ...
    createWheel: function(scene) {
        ...
        scene.wheelborder = addSprite('wheelborder', 0, 77, depth);

        scene.wCont = scene.add.container(scene.centerX, scene.centerY); 

        scene.wheel = addSprite("wheel", 0 - scene.wCont.x, 0 - scene.wCont.y, depth)?.setOrigin(0.5, 0.5).setAngle(0);
        ...
        scene.pointer = addSprite('pointer', 0, -300, depth).setOrigin(0.5, 0.2);
